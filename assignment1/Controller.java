        ...
        studentListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<Student>() {
            ...
            public void changed(ObservableValue<? extends Student> observable, Student oldValue, Student newValue) {
                ...
                */
                ...
                yearStudyView.setText(stu.getYearOfStudy());
                mod1View.setText(stu.getModule1());
                mod2View.setText(stu.getModule2());
                mod3View.setText(stu.getModule3());
            }
        });
        ...
        SortedList<Student> sortedByYear = new SortedList<Student>(StudentData.getInstance().getStudents(),
                new Comparator<Student>() {
                    ...
                    public int compare(Student s1, Student s2) {
                        return s1.getYearOfStudy().compareTo(s2.getYearOfStudy());
                    }
                });
